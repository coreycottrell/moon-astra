...
export const ACTIONS=['build.place','build.cancel','blueprint.deploy','machine.configure','machine.pause','replicator.configure','robot.fabricate','robot.recondition','crew.configure','crew.lend','research.select','design.certify','design.apply','freight.transfer','shipment.send','project.contribute','board.post','board.close','tunnel.dig','claim.pause','claim.grant','claim.revoke'];
