...
export function createMachine(w,c,type,loc,options={}){const m={id:w.nextId++,claimId:c.id,ownerId:c.ownerId,type,...loc,rotation:0,generation:0,progress:0,mode:type==='workshop'?'parts':'off',condition:10000,inventory:{},enabled:true,design:'balanced',produced:0,commissionedAt:w.tick,...options};if(type==='depot'&&!m.depotHub)m.depotHub={bays:2,version:1};w.machines.push(m);return m;}
