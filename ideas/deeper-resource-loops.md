...
Source references: [claim initialization](../src/foundry/state.js), [production](../src/foundry/world.js), [catalog and limits](../src/foundry/catalog.js), [logistics](../src/foundry/logistics.js). The local construction radius is currently 900 m; long-distance outposts, new transport modes and global district simulation would require additional work.
