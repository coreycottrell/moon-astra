...
| Minds change capability | Eight research capabilities, supervision costs, a used/free mind HUD, supported mind nodes, crew budgets and heat limits | Actual model inference inside the simulation, distributed research markets and emergent design discovery |
